  ...
  for (const m of MODELS) {
    try {
      ...
      if (data.error) {
        ...
        // Fall back to next model on temporary failures or quota/model availability errors
...
if (SR) {
  ...
  micBtn.onclick = () => {
    try {
      ...
      console.warn('Speech recognition was already started');
    }
  };
